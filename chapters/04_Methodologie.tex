...
Im Kapitel Methodologie wird das allgemeine Vorgehen beschrieben, welches notwendig ist um die vorgestellten Algorithmen zu implementieren.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.50\textwidth]{resources/content/neural_style_pap.png}
