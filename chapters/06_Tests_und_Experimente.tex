...
Im folgenden wurden die unterschiedlichen Netzwerkearchitekturen auf ihre Performanz getestet. Tests die wegen unzureichendem Arbeitsspeicher oder Grafikspeicher fehlschlagen sind, wurden als \textcolor{danger}{nicht durchführbar} gekennzeichnet. Die Ergebnisse sind in den Anlagen \ref{tab:1920x1080}, \ref{tab:1024x768} und \ref{tab:640x480} angefügt.

Man kann erkennen das die Netzwerke 3, 6, und 9 eine weitaus geringere Berechnungszeit aufweisen. Daraus lässt sich schließen das der Parameter $ m $, welcher die Anzahl der Channels beeinflust, den größten Einfluss auf die Berechnugnsgeschwindigkeit hat. Die Anzahl der ResidualBlocks hingegen, Parameter $ s $, trägt im weitaus geringerem Maße zur Berechnungsgeschwindigkeit bei.
